...
const points = [
  {
    ...
    desc: "Over a decade of delivering ERP solutions tailored to SMEs and enterprises.",
    icon: Award,
  },
  {
    title: "Innovation with Flexibility",
    desc: "We innovate while ensuring your ERP aligns with your business rules.",
    icon: Lightbulb,
  },
  {
    title: "Partnership Approach",
    desc: "We co-create ERP solutions as your long-term digital transformation partner.",
    icon: Handshake,
  },
  {
    title: "Smooth Customization",
    desc: "Quick adaptability of ERP modules to your workflows without disruption.",
    icon: Settings,
  },
];
