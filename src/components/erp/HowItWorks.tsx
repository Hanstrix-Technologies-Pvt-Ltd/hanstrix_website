...
export default function HowItWorks() {
  ...
  // Animate desktop progress bar as the rail scrolls into view
  const { scrollYProgress } = useScroll({
    target: railRef,
    offset: ["start 75%", "end 20%"], // start filling when 75% enters, end before leaving
  });
  ...
  return (
    <section className="px-6 lg:px-20 py-10 md:py-14">
      ...
      {/* Desktop: horizontal stepper with animated progress */}
      <div className="hidden lg:block">
        <div className="relative max-w-6xl mx-auto" ref={railRef} aria-hidden>
          {/* Base rail */}
      ...
      {/* Mobile/Tablet: compact bullet list (points) */}
