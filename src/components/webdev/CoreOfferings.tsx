            ...
            >
              ...
              <div className="relative z-10 p-4 md:p-5 flex flex-col w-full">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <h3
                    className="
                      text-base md:text-lg font-semibold text-white leading-snug
                      min-h-[2.25rem] md:min-h-[2.5rem] flex items-center
                    "
                  >
                    {item.title}
                  </h3>
                ...
                {/* description (flex-1 for equal height) */}
                ...
                {/* focus ring for a11y (card is interactive) */}
                <button
