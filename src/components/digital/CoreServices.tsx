  ...
  return (
    <section className="px-4 sm:px-5 lg:px-16 py-8 md:py-10">
      <motion.h2
        ...
        viewport={{ once: true }}
        className="text-2xl md:text-3xl lg:text-4xl font-bold text-gradient-neon text-center mb-10 md:mb-15"
      >
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, #00C6FF 0%, #8A2BE2 70%, transparent 80%)",
                  }}
                />
                ...
                >
                  ...
                  <div
                    ...
                    className={`absolute inset-y-2 ${
                      leftSide ? "left-[-3px]" : "right-[-3px]"
                    } w-[8px] rounded bg-gradient-to-b ${edgeGrad}`}
                  />
                  {/* glow (mirrored) */}
                  <div
                    aria-hidden
                    className={`absolute inset-y-0 ${
                      leftSide ? "left-[-14px]" : "right-[-14px]"
                    } w-9 blur-xl`}
                    style={{
                      background:
                        "linear-gradient(180deg, rgba(0,198,255,0.48), rgba(138,43,226,0.48))",
                    }}
                  />
                  ...
                  <div className={`relative z-10 p-4 ${leftSide ? "" : "text-right"}`}>
                    ...
                    <p className={`text-gray-300 mt-2 ${leftSide ? "" : "ml-auto"}`}>
                      {s.description}
                    </p>
                    <div
                      className={`mt-3 h-[3px] rounded-full bg-gradient-neon w-[52%] ${
                        leftSide ? "" : "ml-auto"
                      }`}
                    />
                  </div>
      ...
      <div className="md:hidden">
        <div className="space-y-3">
          {services.map((s, i) => (
            ...
            >
              <div className="absolute inset-y-2 left-0 w-[3px] rounded bg-gradient-to-b from-cyan-400 to-purple-500" />
              <div
                className="absolute inset-y-0 left-[-10px] w-7 blur-xl"
                style={{
                  background:
                    "linear-gradient(180deg, rgba(0,198,255,0.45), rgba(138,43,226,0.45))",
                }}
              />
